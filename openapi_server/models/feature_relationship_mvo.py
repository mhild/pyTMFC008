...
class FeatureRelationshipMVO(BaseModel):
    """
    Configuration feature
    """ # noqa: E501
    relationship_type: Optional[StrictStr] = Field(default=None, description="This is the type of the feature relationship.", alias="relationshipType")
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier of the target feature.")
    name: Optional[StrictStr] = Field(default=None, description="This is the name of the target feature.")
    valid_for: Optional[TimePeriod] = Field(default=None, alias="validFor")
    __properties: ClassVar[List[str]] = ["relationshipType", "id", "name", "validFor"]
    ...
    def relationship_type_validate_enum(cls, value):
        ...
        if value not in ('excluded', 'includes', 'may include', 'requires',):
            raise ValueError("must be one of enum values ('excluded', 'includes', 'may include', 'requires')")
        return value
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of FeatureRelationshipMVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of FeatureRelationshipMVO from a dict"""
        if obj is None:
            return None
