...
class CalendarPeriod(BaseModel):
    ...
    hour_period: Optional[List[HourPeriod]] = Field(default=None, alias="hourPeriod")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "hourPeriod": [HourPeriod.from_dict(_item) for _item in obj.get("hourPeriod")] if obj.get("hourPeriod") is not None else None,
