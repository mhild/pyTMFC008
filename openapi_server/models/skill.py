...
class Skill(BaseModel):
    ...
    """ # noqa: E501
    skill_code: Optional[StrictStr] = Field(default=None, description="Code of the skill", alias="skillCode")
    skill_name: Optional[StrictStr] = Field(default=None, description="Name of the skill, such as Java language", alias="skillName")
    evaluated_level: Optional[StrictStr] = Field(default=None, description="Level of expertise in a skill evaluated for an individual", alias="evaluatedLevel")
    comment: Optional[StrictStr] = Field(default=None, description="A free text comment linked to the evaluation done")
    valid_for: Optional[TimePeriod] = Field(default=None, alias="validFor")
    __properties: ClassVar[List[str]] = ["skillCode", "skillName", "evaluatedLevel", "comment", "validFor"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "skillCode": obj.get("skillCode"),
            "skillName": obj.get("skillName"),
            "evaluatedLevel": obj.get("evaluatedLevel"),
