...
class GeographicSubAddressUnitFVO(BaseModel):
    """
    GeographicSubAddressUnitFVO
    """ # noqa: E501
    ...
    sub_unit_number: StrictStr = Field(description="The discriminator used for the subunit, often just a simple number but may also be a range.", alias="subUnitNumber")
    sub_unit_type: StrictStr = Field(description="The type of subunit e.g.BERTH, FLAT, PIER, SUITE, SHOP, TOWER, UNIT, WHARF, RACK", alias="subUnitType")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of GeographicSubAddressUnitFVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of GeographicSubAddressUnitFVO from a dict"""
        if obj is None:
            return None
