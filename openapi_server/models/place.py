...
class Place(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@type", "@baseType", "@schemaLocation", "href", "id"]
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'GeographicAddress': 'GeographicAddress','GeographicLocation': 'GeographicLocation','GeographicSite': 'GeographicSite','Place': 'Place'
    }
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        ...
        if object_type:
            ...
            raise ValueError("Place failed to lookup discriminator value from " +
