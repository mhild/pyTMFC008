...
class RelatedPartyOrPartyRole(BaseModel):
    ...
    party_or_party_role: Optional[PartyOrPartyRole] = Field(default=None, alias="partyOrPartyRole")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of RelatedPartyOrPartyRole from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of RelatedPartyOrPartyRole from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "role": obj.get("role"),
            "partyOrPartyRole": PartyOrPartyRole.from_dict(obj.get("partyOrPartyRole")) if obj.get("partyOrPartyRole") is not None else None
        })
        return _obj

from openapi_server.models.party_or_party_role import PartyOrPartyRole
# TODO: Rewrite to not use raise_errors
RelatedPartyOrPartyRole.model_rebuild(raise_errors=False)
