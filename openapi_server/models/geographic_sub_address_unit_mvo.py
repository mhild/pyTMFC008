...
class GeographicSubAddressUnitMVO(BaseModel):
    """
    ...
    sub_unit_number: Optional[StrictStr] = Field(default=None, description="The discriminator used for the subunit, often just a simple number but may also be a range.", alias="subUnitNumber")
    sub_unit_type: Optional[StrictStr] = Field(default=None, description="The type of subunit e.g.BERTH, FLAT, PIER, SUITE, SHOP, TOWER, UNIT, WHARF, RACK", alias="subUnitType")
    __properties: ClassVar[List[str]] = ["@type", "@baseType", "@schemaLocation", "subUnitNumber", "subUnitType"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of GeographicSubAddressUnitMVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of GeographicSubAddressUnitMVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "subUnitNumber": obj.get("subUnitNumber"),
            "subUnitType": obj.get("subUnitType")
        })
        return _obj
