...
class NumberCharacteristic(Characteristic):
    ...
    value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Value of the characteristic")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of NumberCharacteristic from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of NumberCharacteristic from a dict"""
        if obj is None:
            return None
