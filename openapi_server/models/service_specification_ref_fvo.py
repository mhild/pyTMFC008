...
class ServiceSpecificationRefFVO(BaseModel):
    """
    ServiceSpecificationRefFVO
    """ # noqa: E501
    ...
    version: Optional[StrictStr] = Field(default=None, description="Service specification version")
    __properties: ClassVar[List[str]] = ["@type", "@baseType", "@schemaLocation", "id", "href", "name", "@referredType", "version"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ServiceSpecificationRefFVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ServiceSpecificationRefFVO from a dict"""
        if obj is None:
            return None
