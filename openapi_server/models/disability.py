...
class Disability(BaseModel):
    ...
    """ # noqa: E501
    disability_code: Optional[StrictStr] = Field(default=None, description="Code of the disability", alias="disabilityCode")
    disability_name: Optional[StrictStr] = Field(default=None, description="Name of the disability", alias="disabilityName")
    valid_for: Optional[TimePeriod] = Field(default=None, alias="validFor")
    __properties: ClassVar[List[str]] = ["disabilityCode", "disabilityName", "validFor"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "disabilityCode": obj.get("disabilityCode"),
            "disabilityName": obj.get("disabilityName"),
