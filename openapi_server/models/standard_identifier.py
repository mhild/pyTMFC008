...
class StandardIdentifier(BaseModel):
    """
    StandardIdentifier
    """ # noqa: E501
    ...
    format: Optional[StrictStr] = Field(default=None, description="Standard/Regulatory definition identifier. e.g., ISO 3166-1")
    value: Optional[StrictStr] = Field(default=None, description="The value of the resource in the corresponding standard.e.g., a country code value")
    __properties: ClassVar[List[str]] = ["@type", "@baseType", "@schemaLocation", "href", "id", "format", "value"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of StandardIdentifier from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of StandardIdentifier from a dict"""
        if obj is None:
            return None
