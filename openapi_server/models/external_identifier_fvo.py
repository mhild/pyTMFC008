...
class ExternalIdentifierFVO(BaseModel):
    """
    ...
    id: StrictStr = Field(description="identification of the entity within the external system.")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ExternalIdentifierFVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ExternalIdentifierFVO from a dict"""
        if obj is None:
            return None
