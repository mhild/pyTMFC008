...
class GeographicSiteRelationshipFVO(BaseModel):
    """
    GeographicSiteRelationshipFVO
    """ # noqa: E501
    ...
    id: StrictStr = Field(description="Unique identifier of the related site entity within the server")
    relationship_type: StrictStr = Field(description="Type of relationship", alias="relationshipType")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of GeographicSiteRelationshipFVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of GeographicSiteRelationshipFVO from a dict"""
        if obj is None:
            return None
