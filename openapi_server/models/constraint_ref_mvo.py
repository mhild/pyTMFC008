...
class ConstraintRefMVO(BaseModel):
    """
    ConstraintRefMVO
    """ # noqa: E501
    ...
    version: Optional[StrictStr] = Field(default=None, description="constraint version")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ConstraintRefMVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ConstraintRefMVO from a dict"""
        if obj is None:
            return None
