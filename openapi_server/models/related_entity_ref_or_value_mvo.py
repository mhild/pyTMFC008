...
class RelatedEntityRefOrValueMVO(BaseModel):
    """
    RelatedEntityRefOrValueMVO
    """ # noqa: E501
    ...
    entity: Optional[EntityRefOrValueMVO] = None
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of RelatedEntityRefOrValueMVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of RelatedEntityRefOrValueMVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "role": obj.get("role"),
            "entity": EntityRefOrValueMVO.from_dict(obj.get("entity")) if obj.get("entity") is not None else None
        })
        return _obj
