...
from openapi_server.models.organization_ref_fvo import OrganizationRefFVO
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class OrganizationParentRelationshipFVO(BaseModel):
    """
    ...
    relationship_type: Optional[StrictStr] = Field(default=None, description="Type of the relationship. Could be juridical, hierarchical, geographical, functional for example.", alias="relationshipType")
    organization: Optional[OrganizationRefFVO] = None
    __properties: ClassVar[List[str]] = ["@type", "@baseType", "@schemaLocation", "relationshipType", "organization"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of OrganizationParentRelationshipFVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of OrganizationParentRelationshipFVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "organization": OrganizationRefFVO.from_dict(obj.get("organization")) if obj.get("organization") is not None else None
        })
        return _obj
