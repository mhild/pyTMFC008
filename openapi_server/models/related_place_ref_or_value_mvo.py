...
class RelatedPlaceRefOrValueMVO(BaseModel):
    """
    ...
    place: Optional[PlaceRefOrValueMVO] = None
    __properties: ClassVar[List[str]] = ["@type", "@baseType", "@schemaLocation", "role", "place"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of RelatedPlaceRefOrValueMVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of RelatedPlaceRefOrValueMVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "role": obj.get("role"),
            "place": PlaceRefOrValueMVO.from_dict(obj.get("place")) if obj.get("place") is not None else None
        })
        return _obj
