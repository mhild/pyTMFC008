...
class HubFVO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@type", "@baseType", "@schemaLocation", "callback", "query"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of HubFVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of HubFVO from a dict"""
        if obj is None:
            return None
