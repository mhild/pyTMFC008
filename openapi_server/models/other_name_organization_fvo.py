...
class OtherNameOrganizationFVO(BaseModel):
    """
    ...
    trading_name: Optional[StrictStr] = Field(default=None, description="The name that the organization trades under", alias="tradingName")
    name_type: Optional[StrictStr] = Field(default=None, description="Co. , Inc. , Ltd. , Pty Ltd. , Plc; , Gmbh", alias="nameType")
    ...
    __properties: ClassVar[List[str]] = ["@type", "@baseType", "@schemaLocation", "tradingName", "nameType", "name", "validFor"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of OtherNameOrganizationFVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of OtherNameOrganizationFVO from a dict"""
        if obj is None:
            return None
