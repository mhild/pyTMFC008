...
from openapi_server.models.expression_language_enum import ExpressionLanguageEnum
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class ExpressionMVO(BaseModel):
    """
    ExpressionMVO
    """ # noqa: E501
    ...
    expression_language: Optional[ExpressionLanguageEnum] = Field(default=None, alias="expressionLanguage")
    iri: Optional[StrictStr] = Field(default=None, description="Internationalized Resource Identifier of the intent Expression")
    expression_value: Optional[StrictStr] = Field(default=None, description="expression value is the ontology-encoded form of the Intent such as RDF-XML, Turtle, Json-LD,...", alias="expressionValue")
    __properties: ClassVar[List[str]] = ["@type", "@baseType", "@schemaLocation", "expressionLanguage", "iri", "expressionValue"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ExpressionMVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ExpressionMVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "expressionLanguage": obj.get("expressionLanguage"),
            "iri": obj.get("iri"),
