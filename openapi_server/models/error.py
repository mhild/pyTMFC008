...
class Error(BaseModel):
    ...
    code: StrictStr = Field(description="Application relevant detail, defined in the API or a common list.")
    reason: StrictStr = Field(description="Explanation of the reason for the error which can be shown to a client user.")
    message: Optional[StrictStr] = Field(default=None, description="More details and corrective actions related to the error which can be shown to a client user.")
    status: Optional[StrictStr] = Field(default=None, description="HTTP Error code extension")
    reference_error: Optional[StrictStr] = Field(default=None, description="URI of documentation describing the error.", alias="referenceError")
    __properties: ClassVar[List[str]] = ["@type", "@baseType", "@schemaLocation", "code", "reason", "message", "status", "referenceError"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "referenceError": obj.get("referenceError")
        })
        return _obj
