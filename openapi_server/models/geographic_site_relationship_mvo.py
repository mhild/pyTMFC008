...
class GeographicSiteRelationshipMVO(BaseModel):
    """
    ...
    href: Optional[StrictStr] = Field(default=None, description="Reference of the related geographic site")
    role: Optional[StrictStr] = Field(default=None, description="Role of the related site in the relationship")
    valid_for: Optional[TimePeriod] = Field(default=None, alias="validFor")
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier of the related site entity within the server")
    relationship_type: Optional[StrictStr] = Field(default=None, description="Type of relationship", alias="relationshipType")
    __properties: ClassVar[List[str]] = ["@type", "@baseType", "@schemaLocation", "href", "role", "validFor", "id", "relationshipType"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of GeographicSiteRelationshipMVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of GeographicSiteRelationshipMVO from a dict"""
        if obj is None:
            return None
