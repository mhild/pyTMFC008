...
class NoteMVO(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, description="Identifier of the note within its containing entity")
    author: Optional[StrictStr] = Field(default=None, description="Author of the note")
    var_date: Optional[datetime] = Field(default=None, description="Date of the note", alias="date")
    text: Optional[StrictStr] = Field(default=None, description="Text of the note")
    __properties: ClassVar[List[str]] = ["@type", "@baseType", "@schemaLocation", "id", "author", "date", "text"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of NoteMVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of NoteMVO from a dict"""
        if obj is None:
            return None
