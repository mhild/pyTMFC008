...
from openapi_server.models.organization_ref_mvo import OrganizationRefMVO
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class OrganizationParentRelationshipMVO(BaseModel):
    """
    ...
    organization: Optional[OrganizationRefMVO] = None
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of OrganizationParentRelationshipMVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of OrganizationParentRelationshipMVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "organization": OrganizationRefMVO.from_dict(obj.get("organization")) if obj.get("organization") is not None else None
        })
        return _obj
