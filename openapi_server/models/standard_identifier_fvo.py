...
class StandardIdentifierFVO(BaseModel):
    """
    StandardIdentifierFVO
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["@type", "@baseType", "@schemaLocation", "id", "format", "value"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of StandardIdentifierFVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of StandardIdentifierFVO from a dict"""
        if obj is None:
            return None
