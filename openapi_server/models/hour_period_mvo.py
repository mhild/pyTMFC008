...
class HourPeriodMVO(BaseModel):
    ...
    end_hour: Optional[StrictStr] = Field(default=None, description="The time when the status ends applying", alias="endHour")
    start_hour: Optional[StrictStr] = Field(default=None, description="The time when the status starts applying", alias="startHour")
    __properties: ClassVar[List[str]] = ["@type", "@baseType", "@schemaLocation", "endHour", "startHour"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of HourPeriodMVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of HourPeriodMVO from a dict"""
        if obj is None:
            return None
