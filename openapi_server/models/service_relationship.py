...
class ServiceRelationship(BaseModel):
    ...
    service_relationship_characteristic: Optional[List[Characteristic]] = Field(default=None, alias="serviceRelationshipCharacteristic")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ServiceRelationship from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ServiceRelationship from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "serviceRelationshipCharacteristic": [Characteristic.from_dict(_item) for _item in obj.get("serviceRelationshipCharacteristic")] if obj.get("serviceRelationshipCharacteristic") is not None else None,
            "service": ServiceRefOrValue.from_dict(obj.get("service")) if obj.get("service") is not None else None,
...
ServiceRelationship.model_rebuild(raise_errors=False)
