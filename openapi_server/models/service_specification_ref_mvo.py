...
class ServiceSpecificationRefMVO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["@type", "@baseType", "@schemaLocation", "href", "id", "name", "@referredType", "version"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ServiceSpecificationRefMVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ServiceSpecificationRefMVO from a dict"""
        if obj is None:
            return None
