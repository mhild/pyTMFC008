...
class AttachmentRefFVO(BaseModel):
    """
    AttachmentRefFVO
    """ # noqa: E501
    ...
    url: Optional[StrictStr] = Field(default=None, description="Link to the attachment media/content")
    __properties: ClassVar[List[str]] = ["@type", "@baseType", "@schemaLocation", "id", "href", "name", "@referredType", "description", "url"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AttachmentRefFVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AttachmentRefFVO from a dict"""
        if obj is None:
            return None
