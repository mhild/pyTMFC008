...
class CharacteristicRelationshipMVO(BaseModel):
    """
    ...
    relationship_type: Optional[StrictStr] = Field(default=None, description="The type of relationship", alias="relationshipType")
    __properties: ClassVar[List[str]] = ["@type", "@baseType", "@schemaLocation", "id", "relationshipType"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CharacteristicRelationshipMVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CharacteristicRelationshipMVO from a dict"""
        if obj is None:
            return None
