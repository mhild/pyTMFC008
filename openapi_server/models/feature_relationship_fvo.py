...
class FeatureRelationshipFVO(BaseModel):
    """
    Configuration feature
    """ # noqa: E501
    relationship_type: StrictStr = Field(description="This is the type of the feature relationship.", alias="relationshipType")
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier of the target feature.")
    name: StrictStr = Field(description="This is the name of the target feature.")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of FeatureRelationshipFVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of FeatureRelationshipFVO from a dict"""
        if obj is None:
            return None
