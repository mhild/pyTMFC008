...
class ContactMediumFVO(BaseModel):
    """
    ContactMediumFVO
    """ # noqa: E501
    ...
    id: Optional[StrictStr] = Field(default=None, description="Identifier for this contact medium.")
    preferred: Optional[StrictBool] = Field(default=None, description="If true, indicates that is the preferred contact medium")
    contact_type: Optional[StrictStr] = Field(default=None, description="Type of the contact medium to qualifiy it like pro email / personal email. This is not used to define the contact medium used.", alias="contactType")
    valid_for: Optional[TimePeriod] = Field(default=None, alias="validFor")
    __properties: ClassVar[List[str]] = ["@type", "@baseType", "@schemaLocation", "id", "preferred", "contactType", "validFor"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ContactMediumFVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ContactMediumFVO from a dict"""
        if obj is None:
            return None
