...
class ExpressionFVO(BaseModel):
    ...
    expression_value: StrictStr = Field(description="expression value is the ontology-encoded form of the Intent such as RDF-XML, Turtle, Json-LD,...", alias="expressionValue")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ExpressionFVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ExpressionFVO from a dict"""
        if obj is None:
            return None
