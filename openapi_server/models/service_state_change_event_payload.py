...
class ServiceStateChangeEventPayload(BaseModel):
    """
    ServiceStateChangeEventPayload generic structure
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ServiceStateChangeEventPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ServiceStateChangeEventPayload from a dict"""
        if obj is None:
            return None
