...
class PlaceFVO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@type", "@baseType", "@schemaLocation", "id"]
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'GeographicAddress': 'GeographicAddressFVO','GeographicLocation': 'GeographicLocationFVO','GeographicSite': 'GeographicSiteFVO','Place': 'PlaceFVO'
    }
    ...
    def from_json(cls, json_str: str) -> Union[Self, Self, Self]:
        """Create an instance of PlaceFVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        """Create an instance of PlaceFVO from a dict"""
        ...
        if object_type:
            ...
            raise ValueError("PlaceFVO failed to lookup discriminator value from " +
