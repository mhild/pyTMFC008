...
class PlaceMVO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@type", "@baseType", "@schemaLocation"]
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'GeographicAddress': 'GeographicAddressMVO','GeographicLocation': 'GeographicLocationMVO','GeographicSite': 'GeographicSiteMVO','Place': 'PlaceMVO'
    }
    ...
    def from_json(cls, json_str: str) -> Union[Self, Self, Self]:
        """Create an instance of PlaceMVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Union[Self, Self, Self]:
        """Create an instance of PlaceMVO from a dict"""
        ...
        if object_type:
            ...
            raise ValueError("PlaceMVO failed to lookup discriminator value from " +
