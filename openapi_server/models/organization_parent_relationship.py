...
from openapi_server.models.organization_ref import OrganizationRef
try:
...
class OrganizationParentRelationship(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of OrganizationParentRelationship from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of OrganizationParentRelationship from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "organization": OrganizationRef.from_dict(obj.get("organization")) if obj.get("organization") is not None else None
        })
        return _obj
