...
class CharacteristicRelationshipFVO(BaseModel):
    """
    ...
    id: StrictStr = Field(description="Unique identifier of the characteristic")
    relationship_type: StrictStr = Field(description="The type of relationship", alias="relationshipType")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CharacteristicRelationshipFVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CharacteristicRelationshipFVO from a dict"""
        if obj is None:
            return None
