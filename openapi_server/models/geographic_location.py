...
class GeographicLocation(Place):
    ...
    __properties: ClassVar[List[str]] = ["@type", "@baseType", "@schemaLocation", "href", "id", "bbox"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of GeographicLocation from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of GeographicLocation from a dict"""
        if obj is None:
            return None
