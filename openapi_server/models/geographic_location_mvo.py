...
class GeographicLocationMVO(PlaceMVO):
    """
    GeographicLocationMVO
    """ # noqa: E501
    type: StrictStr = Field(description="The name of the GeoJSON structure used in the geometry attribute", alias="@type")
    ...
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier of the geographic location")
    href: Optional[StrictStr] = Field(default=None, description="An URI used to access to the geographic location resource")
    bbox: Optional[List[Union[StrictFloat, StrictInt]]] = Field(default=None, description="A bounding box array that contains the geometry. The axes order follows the axes order of the geometry")
    __properties: ClassVar[List[str]] = ["@type", "@baseType", "@schemaLocation", "id", "href", "bbox"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('GeoJsonPoint', 'GeoJsonMultiPoint', 'GeoJsonLineString', 'GeoJsonMultiLineString', 'GeoJsonPolygon',):
            raise ValueError("must be one of enum values ('GeoJsonPoint', 'GeoJsonMultiPoint', 'GeoJsonLineString', 'GeoJsonMultiLineString', 'GeoJsonPolygon')")
        return value
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of GeographicLocationMVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of GeographicLocationMVO from a dict"""
        if obj is None:
            return None
