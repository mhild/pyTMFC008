...
class StandardIdentifierMVO(BaseModel):
    """
    StandardIdentifierMVO
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["@type", "@baseType", "@schemaLocation", "format", "value"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of StandardIdentifierMVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of StandardIdentifierMVO from a dict"""
        if obj is None:
            return None
