...
class GeographicLocationRefMVO(BaseModel):
    """
    GeographicLocationRefMVO
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["@type", "@baseType", "@schemaLocation", "href", "id", "name", "@referredType"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of GeographicLocationRefMVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of GeographicLocationRefMVO from a dict"""
        if obj is None:
            return None
