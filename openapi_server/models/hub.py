...
class Hub(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, description="Id of the listener")
    callback: StrictStr = Field(description="The callback being registered.")
    query: Optional[StrictStr] = Field(default=None, description="additional data to be passed")
    __properties: ClassVar[List[str]] = ["@type", "@baseType", "@schemaLocation", "href", "id", "callback", "query"]
