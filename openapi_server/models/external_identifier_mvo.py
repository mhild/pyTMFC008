...
class ExternalIdentifierMVO(BaseModel):
    """
    ...
    owner: Optional[StrictStr] = Field(default=None, description="Name of the external system that owns the entity.")
    external_identifier_type: Optional[StrictStr] = Field(default=None, description="Type of the identification, typically would be the type of the entity within the external system", alias="externalIdentifierType")
    id: Optional[StrictStr] = Field(default=None, description="identification of the entity within the external system.")
    __properties: ClassVar[List[str]] = ["@type", "@baseType", "@schemaLocation", "owner", "externalIdentifierType", "id"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ExternalIdentifierMVO from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ExternalIdentifierMVO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "owner": obj.get("owner"),
            "externalIdentifierType": obj.get("externalIdentifierType"),
            "id": obj.get("id")
        })
        return _obj
