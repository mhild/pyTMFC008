...
class RelatedPlaceRefOrValue(BaseModel):
    ...
    place: Optional[PlaceRefOrValue] = None
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of RelatedPlaceRefOrValue from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of RelatedPlaceRefOrValue from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "role": obj.get("role"),
            "place": PlaceRefOrValue.from_dict(obj.get("place")) if obj.get("place") is not None else None
        })
        return _obj
